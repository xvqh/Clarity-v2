...
async function update(client: Client, msg: any, message: Message) {
    if (!message.guild || !client.user) return;
                    ...
                    .addComponents(
                        new StringSelectMenuBuilder()
                            ...
                            .addOptions({
                                ...
                                label: `Logs Channel: ${message.guild.channels.cache.get(data.antitoxicity.logs)}`,
                                value: "logschannel"
                            }, {
