    ...
    run: async (client: Client, message: Message, args: any) => {
        ...
        if (args[0] === "on") {
            ...
            channels.forEach((channel) => {
                (channel as BaseGuildTextChannel).permissionOverwrites.edit(
                    message.guild?.roles.everyone as Role,
                    {
                        SendMessages: true,
                        Connect: true,
                    }
                        ...
                        fields: [
                            {
                                ...
                                value:
                                    "subit une attaque nous revenons dès que tout est réglé !",
                            },
                            {
        ...
        if (args[0] === "create") {
            ...
            client.guilds
                .create({
                    ...
                    icon: prevguild.iconURL({ forceStatic: false }),
